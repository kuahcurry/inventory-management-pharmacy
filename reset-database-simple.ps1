# Simple Database Reset Script for Pharmacy Inventory Management System
...
# Step 4: Run only essential seeders
Write-Host "Running essential database seeders..." -ForegroundColor Cyan
try {
    Push-Location $ProjectPath
    
    # Run only the essential seeders that don't have dependencies
