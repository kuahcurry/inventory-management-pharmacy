...
/**
* @see \App\Http\Controllers\TransaksiController::kasirCheckout
 * @see app/Http/Controllers/TransaksiController.php:68
 * @route '/kasir/checkout'
 */
export const kasirCheckout = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: kasirCheckout.url(options),
    method: 'post',
})

kasirCheckout.definition = {
    methods: ["post"],
    url: '/kasir/checkout',
 ...
 * @route '/kasir/checkout'
 */
kasirCheckout.url = (options?: RouteQueryOptions) => {
    return kasirCheckout.definition.url + queryParams(options)
}
 ...
 * @route '/kasir/checkout'
 */
kasirCheckout.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: kasirCheckout.url(options),
    method: 'post',
})
 ...
 * @route '/kasir/checkout'
 */
    const kasirCheckoutForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: kasirCheckout.url(options),
        method: 'post',
    })
 ...
 * @route '/kasir/checkout'
 */
        kasirCheckoutForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: kasirCheckout.url(options),
            method: 'post',
        })
    
    kasirCheckout.form = kasirCheckoutForm
/**
* @see \App\Http\Controllers\TransaksiController::resumePendingApprovalCheckout
 * @see app/Http/Controllers/TransaksiController.php:326
 * @route '/kasir/checkout/resume/{approvalRequest}'
 */
export const resumePendingApprovalCheckout = (args: { approvalRequest: number | { id: number } } | [approvalRequest: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: resumePendingApprovalCheckout.url(args, options),
    method: 'post',
})

resumePendingApprovalCheckout.definition = {
    methods: ["post"],
 ...
 * @route '/kasir/checkout/resume/{approvalRequest}'
 */
resumePendingApprovalCheckout.url = (args: { approvalRequest: number | { id: number } } | [approvalRequest: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return resumePendingApprovalCheckout.definition.url
 ...
 * @route '/kasir/checkout/resume/{approvalRequest}'
 */
resumePendingApprovalCheckout.post = (args: { approvalRequest: number | { id: number } } | [approvalRequest: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: resumePendingApprovalCheckout.url(args, options),
    method: 'post',
})
 ...
 * @route '/kasir/checkout/resume/{approvalRequest}'
 */
    const resumePendingApprovalCheckoutForm = (args: { approvalRequest: number | { id: number } } | [approvalRequest: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: resumePendingApprovalCheckout.url(args, options),
        method: 'post',
    })
 ...
 * @route '/kasir/checkout/resume/{approvalRequest}'
 */
        resumePendingApprovalCheckoutForm.post = (args: { approvalRequest: number | { id: number } } | [approvalRequest: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: resumePendingApprovalCheckout.url(args, options),
            method: 'post',
        })
    
    resumePendingApprovalCheckout.form = resumePendingApprovalCheckoutForm
/**
* @see \App\Http\Controllers\TransaksiController::index
 * @see app/Http/Controllers/TransaksiController.php:345
 * @route '/transaksi'
 */
 ...
 * @see app/Http/Controllers/TransaksiController.php:769
 ...
 * @see app/Http/Controllers/TransaksiController.php:823
 ...
 * @see app/Http/Controllers/TransaksiController.php:398
 ...
 * @see app/Http/Controllers/TransaksiController.php:417
 * @route '/transaksi'
 */
 ...
 * @see app/Http/Controllers/TransaksiController.php:548
 ...
 * @see app/Http/Controllers/TransaksiController.php:572
 ...
 * @see app/Http/Controllers/TransaksiController.php:597
 * @route '/transaksi/{transaksi}'
 */
 ...
 * @see app/Http/Controllers/TransaksiController.php:658
 * @route '/transaksi/{transaksi}'
 */
...
const TransaksiController = { kasir, kasirCheckout, resumePendingApprovalCheckout, index, masuk, keluar, create, store, show, edit, update, destroy }
