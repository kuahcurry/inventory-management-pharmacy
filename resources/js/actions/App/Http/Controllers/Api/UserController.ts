 ...
 * @see app/Http/Controllers/Api/UserController.php:106
 ...
 * @see app/Http/Controllers/Api/UserController.php:114
 * @route '/api/users/{user}'
 */
 ...
 * @see app/Http/Controllers/Api/UserController.php:167
 * @route '/api/users/{user}'
 */
...
/**
* @see \App\Http\Controllers\Api\UserController::toggleActive
 * @see app/Http/Controllers/Api/UserController.php:186
 * @route '/api/users/{user}/toggle-active'
 */
...
toggleActive.definition = {
    methods: ["post"],
    url: '/api/users/{user}/toggle-active',
} satisfies RouteDefinition<["post"]>
...
const UserController = { index, store, show, update, destroy, toggleActive }
